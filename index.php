...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img style="height: 50px; margin-top:-20px" src="myLogo.png" alt=""> </a>
    ...
    <div class="main" style="display: flex; align-items: center; justify-content: space-around; position: relative; top:-200px;">

        <div class="men_text" style="flex: 1;">
            <h1 style="font-size: 60px; position: relative; top:130px ; left: 120px;">
                Get Fresh<span style="color: #5CAD32; text-shadow: 1px 1px 1px  rgb(169, 255, 159); margin-left: 15px; font-family: mv boli; line-height: 22px; font-size: 70px;">Food</span><br>in an Easy Way
            </h1>
        </div>

        <div class="main_image">
            <img src="kabab.png" style="width: 500px; position: relative; left: -100px; top:300px">
        </div>

    </div>

    <p style="font-size: 16px; color: #333; margin: 10px 0; width: 550px; text-align: justify; position: relative; left: 123px; top:-300px; line-height: 22px; text-shadow: 1px 1px 1px rgba(170, 170, 170, 0.783); color:dimgray">
    Discover a world of flavor at your doorstep with doFoodies. We're dedicated to delivering delicious meals right to you, ensuring that every bite is a delightful experience. From comforting classics to exotic delights, we're here to satisfy your cravings and make dining easy. Join us and savor the convenience of food delivery, all with a dash of culinary passion.
    </p>

    <div class="main_btn" style="background: #5CAD32; position: relative; left: 123px; top:-280px; width: 150px; cursor: pointer; padding: 12px 25px;">
        <a href="#" style="color: #fff; margin-right: 5px; text-decoration: none;">Order Now</a>
        <i class="fa-solid fa-angle-right" style="color: #fff; transition: 0.3s;"></i>
    </div>
